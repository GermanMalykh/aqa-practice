...
public class RegistrationFormTest extends TestBase {
    ...
    @Test
    @DisplayName("Заполнение формы регистрации с валидацией данных 0")
    @Description("E2E тест заполнения формы регистрации с проверкой всех полей и валидацией отправленных данных 1")
    @Owner("GermanMalykh")
    @Tag("web")
    void fillingPracticeForm0() {
        page.open()
                .cleanupPageElements()
    ...
    @Test
    @DisplayName("Заполнение формы регистрации с валидацией данных 1")
    @Description("E2E тест заполнения формы регистрации с проверкой всех полей и валидацией отправленных данных 1")
    @Owner("GermanMalykh")
    @Tag("web")
    void fillingPracticeForm1() {
        page.open()
                .cleanupPageElements()
                .setFirstName(UserInfo.FIRST_NAME)
                .setLastName(UserInfo.LAST_NAME)
